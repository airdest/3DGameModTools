...
but it's still very hard to understand if you are first time to this kind of vertex merge script.
...
def main():
    ...
    # 1.除了TEXCOORD1外，其它冗余的TEXCOORD都是需要保留的
    # TODO 2.AlignedByteOffset要重新赋值

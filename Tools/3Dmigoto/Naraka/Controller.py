...
# 便于设置工作目录
work_dir = "C:/Users/Administrator/Desktop/FrameAnalysis-2023-01-27-201111/"
def move_dds_file():
    # 设置当前目录
    os.chdir(work_dir)
...
def get_format_by_name(element_name):
...
def revise_model_by_output_control(rectified_triangle_list):
    ...
    for vbmodel in rectified_triangle_list:
        ...
        for element in element_list:
            # 修正Format
            format = get_format_by_name(element.semantic_name)

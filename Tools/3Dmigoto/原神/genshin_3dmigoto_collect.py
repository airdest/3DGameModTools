...
# that the Blender Guides plugin recognizes
...
def main():
    ...
    if args.framedump:
        ...
        frame_dump_folder = [x for x in os.listdir("../../../GameFixs/Naraka") if "FrameAnalysis" in x][-1]
...
# python .\genshin_3dmigoto_collect.py -vb 098bced6 -n jianan